...
Required Steps for a Passing Submission:
 ...
 Define the start and goal locations.Perform a search using A* or other search algorithm.Use a collinearity test or ray tracing method (like Bresenham) to remove unnecessary waypoints.
